...
$ubah		= mysqli_query($conn,"UPDATE uangkeluar SET tanggal ='$tanggal', jumlah = '$jumlah', kategori = '$kategori', keterangan = '$keterangan' WHERE id = '$id' ") or die(mysqli_error($conn));
if ($ubah) {
